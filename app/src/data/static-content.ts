...
export const tools: ToolItem[] = [
  ...
  { id: 'compare', name: 'University compare', description: 'Open the counselor to compare sourced fit, cost, language, and deadlines side by side.', tag: 'In chat', view: 'counselor' },
