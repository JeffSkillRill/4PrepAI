...
export type ProfilePayload = { source: { url: string }; internationalStudentPct?: string; facultyCount?: string; employabilityRate?: string; employabilitySummary?: string; costOfLiving?: Partial<Record<'accommodation'|'food'|'transport'|'utilities', string>>; rankings?: Array<{ label: string; rankDisplay: string; year?: number }>; campuses?: Array<{ name: string; city: string; country: string }>; programmes?: Programme[] }
